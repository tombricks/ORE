...
NGame = {
	...
	OIL_RESOURCE= "load_bearing_resource",			-- Name of the oil resource
	FUEL_RESOURCE = "load_bearing_resource",		-- resource that will give country fuel
	ENERGY_RESOURCE = "load_bearing_resource",		-- resource that will give country energy 
